...
n1.load_checkpoint('./pretrained_models/connect4/pytorch', 'connect4_5_best.pth.tar')
...
if human_vs_cpu:
    ...
    # n2.load_checkpoint('./pretrained_models/connect4/pytorch', 'connect4_5_best.pth.tar')
    n2 = gp
    args2 = dotdict({'numMCTSSims': 50, 'cpuct': 1.0})
    mcts2 = MCTS(g, n2, args2)
    n2p = lambda x: np.argmax(mcts2.getActionProb(x, temp=0))

    player2 = n2p  # Player 2 is neural network if it's cpu vs cpu.4
